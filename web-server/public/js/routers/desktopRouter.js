define([
  ...
  var Router = Backbone.Router.extend({
    initialize: function() {
      ...
      this.game = new GameClient(); // from globalview
    ...
    connect: function(callback) {
      if (!this.game.connection.host) {
        // game is an instance of GameClient
        // host is undefined. fixed by manually setting this.game.connection.host = "http://127.0.0.1";
        this.game.connection.host = "http://127.0.0.1";
